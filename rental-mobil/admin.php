  ...
  <body>
	...
	if( isset($_REQUEST['hlm'] )){
		...
		switch( $hlm ){
			case 'transaksi':
				$subfolder = "transaksi";
				include $folder."/".$subfolder."/transaksi.php";
				break;
			case 'laporan':
				$subfolder = "laporan";
				include $folder."/".$subfolder."/laporan.php";
				break;
			case 'user':
				$subfolder = "user";
				include $folder."/".$subfolder."/user.php";
				break;
			case 'mobil':
				$subfolder = "mobil";
				include $folder."/".$subfolder."/mobil.php";
				break;
			case 'print':
				$subfolder = "print";
				include $folder."/".$subfolder."/transaksiPrint.php";
				break;
		}
	} else {
	?>
